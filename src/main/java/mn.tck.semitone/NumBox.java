...
public class NumBox extends FrameLayout {
    ...
    public NumBox(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.NumBox, 0, 0);
        try {
            ...
            ((TextView) view.findViewById(R.id.label))
                    .setText(a.getString(R.styleable.NumBox_label));
            valueView.setText("" + value);
        } finally {
            a.recycle();
        }

        ((TextView) view.findViewById(R.id.minus))
                .setOnClickListener(
        ...
        ((TextView) view.findViewById(R.id.plus))
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
